...
const PostDetails = () => {
  return (
    <section className="p-5 font-poppins">
      <div className="lg:max-w-[70vw] max-lg:max-w-[85vw] rounded-md bg-white mx-auto flex flex-col p-10">
