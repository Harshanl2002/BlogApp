...
import {cat,modules,format,editpostvar} from "../const";
import img from "../assets/img.jpg";
import ReactQuill,{ Quill } from 'react-quill'; // ES6
import "react-quill/dist/quill.snow.css";

export default function Editpost() {
  const  [title,SetTitle]=useState(editpostvar.title);
  const [catagory,SetCatagory]=useState(editpostvar.catogory);
  const [body,setBody]=useState(editpostvar.content);
  const [thumbnail,setThumbnail]=useState(editpostvar.thumbnail);
  return (
