...
const submithandeller=async(e)=>{
  ...
  try {
    ...
    formdata.append("thumpnail",thumpnail);
    formdata.append("title",title);
    formdata.append("content",body);
    formdata.append("catagory",catagory);
    // console.log(formdata);
    const response=await axios.post(`${BaseURIAPI}posts/`,formdata,{headers:myHeaders});
  ...
  return (
    <section className='min-h-[80vh] font-poppins p-5'>
      <div className='min-h-[80vh] font-poppins p-5'>
